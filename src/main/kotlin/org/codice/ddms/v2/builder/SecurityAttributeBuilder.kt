...
class SecurityAttributeBuilder : Builder<SecurityAttributes> {
    ...
    private var declassDate: String = ""
    ...
    private var dateOfExemptedSource: String = ""
    ...
    fun declassDate(declassDate: String): SecurityAttributeBuilder {
    ...
    fun dateOfExemptedSource(dateOfExemptedSource: String): SecurityAttributeBuilder {
